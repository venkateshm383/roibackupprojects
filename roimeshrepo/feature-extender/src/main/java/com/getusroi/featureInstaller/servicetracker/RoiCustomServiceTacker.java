package com.getusroi.featureInstaller.servicetracker;
...
public class RoiCustomServiceTacker implements
ServiceTrackerCustomizer{
	final static Logger logger = LoggerFactory.getLogger(RoiCustomServiceTacker.class);

	  private final BundleContext bundleContext;
	public RoiCustomServiceTacker(BundleContext bundleContext) {
