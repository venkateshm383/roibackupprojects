...
import com.getusroi.featureInstaller.bundle.tracker.impl.FeatureMetaInfoExtender;
import com.getusroi.featureInstaller.bundle.tracker.impl.FeatureMetaInfoExtenderException;
import com.getusroi.featureInstaller.servicetracker.RoiCustomServiceTacker;
...
public class Activator implements BundleActivator {
    ...
    public void start(BundleContext context) throws FeatureMetaInfoExtenderException {
        ...
        RoiCustomServiceTacker permastoreServiceTracker=new RoiCustomServiceTacker(context);
			serviceTracker = new ServiceTracker(context, IPermaStoreCustomCacheObjectBuilder.class
				        .getName(), permastoreServiceTracker);
			serviceTracker1 = new ServiceTracker(context, IROIEventTransformer.class
			        .getName(), permastoreServiceTracker);
			serviceTracker.open();
