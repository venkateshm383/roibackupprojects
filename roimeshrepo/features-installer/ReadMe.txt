...
•	Once all the configuration is loaded, it will load, parse the “baseRoute.xml” file available in “mesh-core” project and start the camel context defined in it.
