...
import com.getusroi.integrationfwk.activities.bean.EmailNotifier;
import com.getusroi.integrationfwk.activities.bean.EmailNotifierException;
import com.getusroi.integrationfwk.config.jaxb.MailAttachments;
...
public class EmailPipeLineUtil {
	...
	/**
	 * method to set the exchange body in meshHeader and set the body node from
	...
	public void setExchangeBodyToMeshHeader(Exchange exchange) throws EmailNotifierException, IOException {
		...
		// Setting exchange body into MeshHeader
		MeshConfigurationUtil meshConfigUtil = new MeshConfigurationUtil();
		meshConfigUtil.setIntegrationPipeContext(xmlInput, exchange);
	...
	/**
	 * method to get the mesh header into the exchange
	 * 
	 * @param exchange
	 * @throws EmailNotifierException
	 */
	public void getMeshHeaderToExchangeBody(Exchange exchange) throws EmailNotifierException {
		MeshConfigurationUtil meshConfigurationUtil = new MeshConfigurationUtil();
		meshConfigurationUtil.getIntegrationPipeContext(exchange);
	}// end of method
