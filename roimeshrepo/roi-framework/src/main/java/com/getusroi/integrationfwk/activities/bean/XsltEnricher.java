...
public class XsltEnricher {
	...
	private String xsltTransformFactory(String inputXml, String xsltName, Exchange exchange)
		...
		logger.debug(".XsltPath : " + xsltFile);
		InputStream in;
		try {
...
public static void main(String[] a) throws StaticConfigFetchException, StaticConfigInitializationException, AccessProtectionException, InstantiationException, IllegalAccessException{
	IStaticConfigurationService iStaticConfigurationService = StaticConfigurationFactory.getFilemanagerInstance();
	System.out.println("jjjj");
	RequestContext requestContext = new RequestContext("gap", "Site1", "performance", "performancetesting", "performing", "1.0");
	String xsltFile = iStaticConfigurationService.getStaticConfiguration(requestContext, "FEDEX_Ship_GeniricToRaw.xsl");
