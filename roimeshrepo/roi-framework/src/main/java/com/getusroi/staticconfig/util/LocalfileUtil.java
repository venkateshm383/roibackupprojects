...
public class LocalfileUtil {
	...
	public static String initialize(String staticConfigRootDirectory)
			throws StaticConfigInitializationException, AccessProtectionException {
		staticConfigRootDirectory = loadStaticConfigProperty();
		if (staticConfigRootDirectory.contains(WIN_PATH_PATTERN) && isWindows()
	 ...
	 * 
	 */
	public String getStaticFilePath(RequestContext reqCtx, String fileName) throws StaticConfigInitializationException, AccessProtectionException{
