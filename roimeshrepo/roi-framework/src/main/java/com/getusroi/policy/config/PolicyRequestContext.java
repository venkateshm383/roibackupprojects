...
public class PolicyRequestContext extends RequestContext implements Serializable{
	...
	public PolicyRequestContext(String tenantId, String siteId, String featureGroup, String featureName) {
		super(tenantId, siteId, featureGroup, featureName);
		
	}
	public PolicyRequestContext(String tenantId, String siteId, String featureGroup, String featureName,String vendor,String version) {
		super(tenantId, siteId, featureGroup, featureName,vendor,version);
