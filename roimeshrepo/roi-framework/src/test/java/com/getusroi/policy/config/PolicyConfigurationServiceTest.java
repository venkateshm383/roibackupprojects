...
InputStream inputstream = PermaStoreConfigXMLParser.class.getClassLoader().getResourceAsStream(PolicyTestConstant.policy_linked_permaStore_configfile);
	...
	public void testPolicyUpload() throws PolicyConfigurationException {
		...
		ConfigurationContext configurationContext=new ConfigurationContext(GenericTestConstant.getTenant(), GenericTestConstant.getSite(),GenericTestConstant.getFeatureGroup(),GenericTestConstant.getFeature(),GenericTestConstant.TEST_VENDOR,GenericTestConstant.TEST_VERSION);
	...
	public void testChangeStatusOfPolicyconfigDisable() throws PolicyConfigurationException, ConfigPersistenceException,
		...
		PolicyRequestContext requestContext = new PolicyRequestContext(GenericTestConstant.getTenant(), GenericTestConstant.getSite(),GenericTestConstant.getFeatureGroup(), GenericTestConstant.getFeature(),GenericTestConstant.TEST_VENDOR,GenericTestConstant.TEST_VERSION);
	...
	public void testPolicyEvalutionRequestHandlerForSQLDailect() throws PolicyConfigurationException, ConfigPersistenceException, PolicyConfigXMLParserException, PolicyRequestException, PermaStoreConfigurationException, PermaStoreConfigParserException, ConfigServerInitializationException, PolicyInvalidRegexExpception{
		...
		PolicyRequestContext policyRequestContext=new PolicyRequestContext(GenericTestConstant.getTenant(), GenericTestConstant.getSite(),GenericTestConstant.getFeatureGroup(),GenericTestConstant.getFeature(),GenericTestConstant.TEST_VENDOR,GenericTestConstant.TEST_VERSION);
