 ...
 */
public class MeshHCEventConsumer extends ScheduledPollConsumer {
	final Logger logger = LoggerFactory.getLogger(MeshHCEventConsumer.class); 
	private final MeshHCEventEndpoint endpoint;

    public MeshHCEventConsumer(MeshHCEventEndpoint endpoint, Processor processor,HazelcastInstance hazelcastInstance) {
