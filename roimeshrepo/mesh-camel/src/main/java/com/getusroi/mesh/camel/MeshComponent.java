...
/**
 * Represents the component that manages {@link MeshHCEventEndpoint}.
 */
public class MeshComponent extends DefaultComponent {
	final Logger logger = LoggerFactory.getLogger(MeshComponent.class);
	...
	protected Endpoint createEndpoint(String uri, String remaining, Map<String, Object> parameters) throws Exception {
   	 ...
   	 if(remaining!=null && remaining.equalsIgnoreCase("Event")){
      	 ...
      	 Endpoint endpoint = new MeshFwkEndpoint(uri, this);
    ...
    private Endpoint createHCEventEndpoint(String uri, String remaining, Map<String, Object> parameters) throws Exception{
   	 ...
   	 Endpoint endpoint = new MeshHCEventEndpoint(uri, this,hazelcastInstance);
   	 setProperties(endpoint, parameters);
       return endpoint;
    }
