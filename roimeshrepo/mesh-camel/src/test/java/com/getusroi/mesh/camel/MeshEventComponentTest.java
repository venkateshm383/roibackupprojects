...
public class MeshEventComponentTest extends CamelTestSupport
{
	static final Logger logger = LoggerFactory.getLogger(MeshEventComponentTest.class);
    ...
    public static void main(String args[]) throws Exception{
   	 ...
   	 context.addRoutes(new RouteBuilder() {
   		 public void configure() {
             ...
             from("mesh://Event?eventId=PicCompletedEvent&subscriberId=mockroute")
           	.log(LoggingLevel.DEBUG, ">>Processing ${body}")
             .to("mock:result"); 
        }
   	});
