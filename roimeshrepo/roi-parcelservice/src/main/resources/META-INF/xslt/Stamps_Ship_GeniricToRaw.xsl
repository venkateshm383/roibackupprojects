		...
		<ShipmentRequest>
			...
			<Shipment>
				...
				<Package>
					...
					<ShipDate><xsl:value-of
								select="Shipment/Packages/Package/ShipDate" /></ShipDate>
								<xsl:if test="Shipment/Packages/Package/Machinable/text() = 'true'">
					<NonMachinable>false</NonMachinable>
								</xsl:if>
								<xsl:if test="Shipment/Packages/Package/Machinable/text() = 'false'">
