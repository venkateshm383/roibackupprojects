		...
		<SOAP-ENV:Envelope>
			<SOAP-ENV:Body>
				<RateRequest>
					...
					<TransactionDetail>
						<!-- <CustomerTransactionId> <xsl:value-of select="RateRequest/TransactionDetail/CustomerTransactionId" 
					...
					<RequestedShipment>
						...
						<!-- <ServiceType> <xsl:value-of select="RateRequest/RequestedShipment/ServiceType" 
							/> </ServiceType> -->
						<PackagingType>
							<xsl:value-of
